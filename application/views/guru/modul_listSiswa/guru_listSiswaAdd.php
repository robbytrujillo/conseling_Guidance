              ...
              <div class="row mb-2">
                ...
                <div class="col-sm-6">
                  <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="<?= base_url('Guru/listSiswaAdd');?>"><small><?= $page ;?></small></a></li>
                  </ol>
                </div><!-- /.col -->
              </div><!-- /.row -->
            ...
            <div class="container-fluid col-sm-8">
              ...
              <div class="card card-outline card-info">
                ...
                <div class="card-body">
                  ...
                  <form action="<?= base_url('Guru/listSiswaAdd')?>" method="post">
                    ...
                    <div class="form-group text-right">
                      <a class="btn btn-danger btn-sm" href="<?= base_url('Guru/listSiswaAdd');?>"><i class="fa fa-undo"></i>&ensp;Reset</a>
