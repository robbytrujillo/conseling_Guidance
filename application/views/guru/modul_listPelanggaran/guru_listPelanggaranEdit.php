              ...
              <div class="row mb-2">
                ...
                <div class="col-sm-6">
                  <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="<?= base_url('Guru/dataKategoriListPelanggaran');?>"><small><?= $parent ;?></small></a></li>
                    <li class="breadcrumb-item"><a href="<?= base_url('Guru/dataKategoriListPelanggaranEdit/'.$this->encrypt->encode($onepel->id_pelanggaran));?>"><small><?= $page ;?></small></a></li>
                  </ol>
                </div><!-- /.col -->
              </div><!-- /.row -->
            ...
            <div class="container-fluid col-sm-8">
              ...
              <div class="card card-outline card-info">
                ...
                <div class="card-body">
                  ...
                  <form action="<?= base_url('Guru/listPelanggaranEdit/'.$this->encrypt->encode($onepel->id_pelanggaran).'')?>" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <select name="pelapor" id="pelapor" class="form-control select2" style="width: 100%;" >
                        ...
                        foreach ($guruAll as $guru) {
                          ...
                          if($guru->id == $onepel->teacher_id){
                            echo '<option value="'.$guru->id.'" selected="selected">'.$guru->teacher_name.'</option>';
                    ...
                    <div class="form-group">
                      ...
                      <textarea type="text" name="catatan" class="form-control" id="catatan" placeholder="tulis disini"><?= $onepel->note ;?></textarea>
